# ══════════════════════════════════════════════════════════════════════════════
# Página: Admin Evaluaciones
# Solo para el administrador (César). Abrir/cerrar evaluaciones por obra,
...
st.set_page_config(page_title="Admin Evaluaciones", page_icon="⚙️", layout="wide")
...
<div style="background:{AZUL};padding:18px 24px;border-radius:12px;margin-bottom:20px;border-bottom:4px solid {NARANJO};">
  <div style="color:white;font-size:1.6rem;font-weight:800;">⚙️ Administración de Evaluaciones</div>
</div>
